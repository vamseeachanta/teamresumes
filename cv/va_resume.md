...
### Subsea Engineering leader (20+ years) for sustainable and automated engineering solutions, workflows and project success enabler
...
- Ability to lead and/or perform analysis as well as lead teams. Over 20 years of experience in employee mentoring, leading, project management and business development. Lead growth teams, manage projects and possess project evaluation experience. Experience (and thrive) in start-up and challenging environments.
- Strong in-place and installation analysis using leading FE Software, particularly Orcaflex, Abaqus, Ansys.
...
- Data science experience to implement physics-based algorithms in production environment for engineering teams. Working experience in :
  ...
  - Visualizations (spotfire, Power BI, python plotly, matplotlib modules).
- Possess qualities of teamwork, adaptation, hard work, perseverance, end-to-end knowledge-sharing documentation, resilience and servant leadership.
...
|---------|--------|--------|
| Field Development | Onshore and offshore planning analysis from cradle to grave <br> Wet tree vs. dry tree <br> Well drilling, completion, production, interventions, abandonment | Field economics <br> Facilities planning |
...
| Subsea Installations design | pipelines, umbilicals, risers, jumpers, manifolds etc | Design,Installation analysis <br> detailed structural analysis |
...
| Project |   Skills |
|---------|--------|
| BP Macondo Containment Riser detailed design | Detailed design and delivery lead <br>Global riser and subsea lines analysis; Suction pile design; <br>Upper and lower flexible jumper designs; <br>Installation analysis of all key components |  N/A |
...
| Generic: Rigid Pipeline installation | Shallow and deepwater pipeline installation weather window analysis <br> Global and local Buckling analysis <br> Fatigue analysis
...
- Specialty in deepwater riser & pipeline design for production, drilling and interventions/workover operations for multiple O&G projects.
  - Line size, material selection, etc from concept to detailed design
  ...
  - Key pipeline projects are:
    - On-bottom stability analysis, free span analysis, VIV analysis, lateral and thermal buckling, fatigue analysis using screening, analytical analysis and detailed anlaysis using software tools such as OrcaFlex, Abaqus, ANSYS etc.
    - Detailed subsea pipeline engineering analysis for installation of 42 inch thin walled pipe offshore Venezuela
    - Detailed design of GoM Thunder Horse, Atlantis pipelines
    - FEED and feasibility designs for multiple projects
  - Key riser projects are:
...
- Integrity specialist responsible for inspection of existing KG-D6 infrastructure and integrity lead on subsea systems.
  - Inspection reports and engineering assessments requirements were given as part of the integrity program. These assessments were done for risers, flowlines and subsea equipment including umbilicals, manifolds, jumpers and trees.
